...
class DroneControl(object):
    ...
    def connect(self):
        #Initiates connection on the TCP ports. This must be run
        #before attempting to send control commands to the Drone.
        
        t = threading.Thread(target=self.Tcp_contact)
        t.start()

    def checksum(self, data):
        #The flight data has to be passed through a checksum.
        #Returns: the 8 bit xor checksum of the data
